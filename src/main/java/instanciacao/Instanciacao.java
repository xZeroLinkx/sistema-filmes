...
public class Instanciacao extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Participacao p1 = new Participacao(null, "Jack Dawson", new BigDecimal("2000000.00"), a1, f2);
			Participacao p2 = new Participacao(null, "Howard Hughes", new BigDecimal("1000000.00"), a1, f1);
			Participacao p3 = new Participacao(null, "Rose Bukater", new BigDecimal("1000000.00"), a3, f2);
			Participacao p4 = new Participacao(null, "Katharine Hepburn", new BigDecimal("500000.00"), a2, f1);
